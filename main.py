...
def get_market_data():
    ...
    # H200 are 141GB RAM. Cautam monstrii cu peste 100GB.
    query_params = {
        "rentable": {"eq": True},
        "gpu_ram": {"gt": 100000}, 
        "type": "on-demand"
        ...
        if response.status_code == 200:
            ...
            if offers:
                ...
                for o in offers:
                    ...
                    # FILTRU STRICT: Doar H200
                    if "H200" in name and price > 0.1:
                ...
                if relevant_prices:
                    ...
                    print("⚠️ No H200 units found in Spot Market right now (Scarce Asset).")
...
def main():
    ...
    if price:
        ...
        # Calculam cat castigam fata de Benchmark
